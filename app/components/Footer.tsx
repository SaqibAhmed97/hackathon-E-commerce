...
export default function Footer() {
    return (
      <footer className="bg-Button h-auto flex flex-col justify-center bg-[#fff1dfbe] items-center w-full px-4 sm:px-8 md:px-16 lg:px-[100px] py-7 md:py-5">
  ...
  <span className="text-blue-600 hover:underline">F</span>
  <span className="text-black hover:underline">urniro.</span>
  </h2>
            ...
            <div className="flex flex-col gap-[50px] w-full lg:w-[30%] h- pl-3">
    ...
    <li className="hover:underline hover:text-blue-600 cursor-pointer">Privacy Policies</li>
            ...
            <div className="flex flex-col gap-[50px] w-full lg:w-[30%]">
              ...
              <div className="flex gap-4 sm:gap-8 flex-col sm:flex-row">
                ...
                <button className="text-[14px] font-medium text-black border-0 border-b border-black w-fit hover:text-white cursor-pointer box-border bg-red-600">
                  SUBSCRIBE
                </button>
              </div>
            </div>
